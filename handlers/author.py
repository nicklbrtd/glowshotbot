...
def _author_portfolio_text() -> str:
    return (
        ...
        "Скоро: Сайт-Портфолио, где вы сможете добавить свои работы, рассказать о себе и поделиться ссылками. А пока — группа авторов, где можно общаться с другими авторами и получать новости."
    )
