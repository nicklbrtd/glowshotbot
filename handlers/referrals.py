...
async def _build_ref_main_text(user_tg_id: int, obj) -> str:
    ...
    условия, ссылка и статистика «ты привёл N друзей».
    """
    ...
    text = (
        ...
        "Приведи одного друга, чтобы получить <b>1 день премиума</b>.\n"
        "Ты получишь премиум, если друг зарегистрируется в боте и оценит хотя бы одну чужую работу.\n\n"
        "По твоей реферальной ссылке друг <b>тоже получает 1 день премиума</b> при выполнении условий.\n"
        "Для участия в итогах дня нужно пригласить <b>двоих</b> друзей. Твой друг тоже должен пригласить двоих, чтобы участвовать в итогах.\n\n"
...
async def ref_more(callback: CallbackQuery):
    ...
    text = (
        ...
        "— Реферальные бонусы суммируются: пригласил нескольких друзей — получил больше дней премиума.\n"
        "— За нарушения правил (спам, фейковые аккаунты, накрутка) мы можем обнулить реферальный прогресс.\n\n"
        "Используй реферальную ссылку аккуратно и делись ею с теми, кому реально интересна фотография 📸"
    )
    kb = _build_ref_kb()
...
async def ref_premium_info(callback: CallbackQuery):
    ...
    text = (
        ...
        "Часть премиум-дней можно получить не только покупкой, но и через реферальную программу —\n"
        "приводи друзей, которым интересна фотография, и получай бонусные дни 💫"
    )
    kb = _build_ref_kb()
