...
async def _build_ref_main_text(user_tg_id: int, obj) -> str:
    ...
    text = (
        ...
        "Приведи одного друга, чтобы получить <b>2 дня премиума</b>.\n"
        "Ты получишь премиум, если друг зарегистрируется в боте и поставит хотя бы одну оценку "
        "в разделе «Моя фотография».\n\n"
...
async def ref_more(callback: CallbackQuery):
    ...
    text = (
        ...
        "   • выложит свою первую фотографию;\n"
