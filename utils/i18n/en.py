EN = {
    ...
    "profile.author.apply.hint": "Send <b>5–10</b> of your photos (ideally as one album). Then tap “Submit request”.",
    "profile.author.apply.count": "Added photos: {count}/10",
    "profile.author.apply.need_more": "Need at least 5 photos. Currently {count}.",
    "profile.author.apply.too_many": "Maximum is 10 photos. Remove extras or start over.",
